...
const SignUp = () => {
  const { errors, currentUser, isFetchingRegister, registrado } = useSelector(
    (state) => state.auth
  );
          ...
          <div id="register-content">
            <div className="top-info-register">
              <NavLink className="back-top" to="/">
                <i id="arrow-back" className="bi w bi-arrow-left" />
              </NavLink>
              <h6 className="info-top">
                <strong className="w">Nuevo Usuario</strong>{" "}
                {error ? (
                  <small className="err">
                    Ups! Debes completar los campos correctamente
                  </small>
                ) : (
                  ""
                )}
            ...
            <form id="register-form" autoComplete="off">
              ...
              <div className="add-button-password">
                ...
                >
                  {openOne ? (
                    <i className="bi w size-icon-pass bi-eye-slash" />
                  ) : (
                    <i className="bi w size-icon-pass bi-eye" />
                  )}
                </button>
              </div>
